    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/stats/stations/**").hasAnyAuthority("STAFF", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/stats/stations/utilization").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/stats/stations/revenue/quick-summary").hasAuthority("ADMIN")
